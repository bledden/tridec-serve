...
json.dump({"backend": "triton", "rows": rows}, open(f"/workspace/bench/results_dist_d13_{PLAT}.json", "w"), indent=2)
...
json.dump(bf, open(f"/workspace/bench/results_bigfleet_{PLAT}.json", "w"), indent=2)
print("saved")
